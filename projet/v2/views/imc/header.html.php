  ...
  <nav class="navbar navbar-expand-lg navbar-dark ">
    ...
    <div class="collapse navbar-collapse ml-5" id="navbarColor01">
      <ul class="navbar-nav mr-auto">
        <?php if (!est_gestionnaire() && !est_responsable()) : ?>
          <li class="nav-item active">
            <a class="nav-link" href="<?= WEB_ROUTE . '?controlleurs=vehicule&views=liste.vehicule' ?>">Accueil
          ...
          <?php if (est_gestionnaire()) : ?>
            ...
            <ul class="navbar-nav mr-o ml-4">
              <li class="nav-item dropdown mr-md-5">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Vehicule</a>
            ...
            <ul class="navbar-nav mr-o ">
              <li class="nav-item dropdown mr-md-5">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Parametrage</a>
                <div class="dropdown-menu ">
      ...
      <ul class="navbar-nav mr-o mr-4">
        ...
        <li class="nav-item dropdown mr-md-5">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?= est_connect() ? $_SESSION['userConnect']['prenom_user'] . ' ' . $_SESSION['userConnect']['nom_user'] : " Utilisateur" ?></a>
          <?php if (!est_connect()) : ?>
            <div class="dropdown-menu ">
